...
import NguyenThiMyHoa.Q1_SolveEquation;
...
class Q1_SolveEquationTest {

    Q1_SolveEquation se = new Q1_SolveEquation();
    ...
    @Test
    void testMultiRoots() {
        String given = "number1 = 0, number2 = 0";
        String when = "linearEquation(0, 0)";
        String expected = "Multi roots";
        recordResult(given, when, expected, se.linearEquation(0, 0));
    }

    @Test
    void testNoRoot() {
        String given = "number1 = 0, number2 = 5";
        String when = "linearEquation(0, 5)";
        String expected = "No root";
        recordResult(given, when, expected, se.linearEquation(0, 5));
    }

    @Test
    void testOneRoot() {
        String given = "number1 = 3, number2 = 7";
        String when = "linearEquation(3, 7)";
        String expected = "One root";
        recordResult(given, when, expected, se.linearEquation(3, 7));
    }

    @AfterAll
    static void generateReport() {
        StringBuilder html = new StringBuilder();
        html.append("<html><head><meta charset=\"UTF-8\"><title>Test Report - Question 1</title>");
        html.append("<style>");
        ...
        html.append("<h2>Test Report - Question 1 (Q1_SolveEquation)</h2>");
        html.append("<table>");
        ...
        try (FileWriter writer = new FileWriter(new File(outputDir, "test-report-q1.html"))) {
