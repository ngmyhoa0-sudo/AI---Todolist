...
import NguyenThiMyHoa.Q4_Sort1;
...
class Q4_Sort1Test {
    ...
    void testNumber1GreaterThanNumber2() {
        Q4_Sort1 sorter = new Q4_Sort1();
        sorter.setNumber1(10);
        sorter.setNumber2(5);
        sorter.sortAsc();
        String actual = "number1=" + sorter.getNumber1() + ", number2=" + sorter.getNumber2();
        recordResult("number1=10, number2=5", "sortAsc()", "number1=5, number2=10", actual);
    }
    ...
    void testNumber1LessThanNumber2() {
        ...
        sorter.sortAsc();
        String actual = "number1=" + sorter.getNumber1() + ", number2=" + sorter.getNumber2();
        recordResult("number1=5, number2=10", "sortAsc()", "number1=5, number2=10", actual);
    }
    ...
    void testNumbersEqual() {
        ...
        sorter.sortAsc();
        String actual = "number1=" + sorter.getNumber1() + ", number2=" + sorter.getNumber2();
        recordResult("number1=7, number2=7", "sortAsc()", "number1=7, number2=7", actual);
    }

    @AfterAll
    static void generateReport() {
        StringBuilder html = new StringBuilder();
        html.append("<html><head><meta charset=\"UTF-8\"><title>Test Report - Question 4</title>");
        html.append("<style>");
        ...
        html.append("<h2>Test Report - Question 4 (Q4_Sort1)</h2>");
        html.append("<table>");
        ...
        try (FileWriter writer = new FileWriter(new File(outputDir, "test-report-q4.html"))) {
